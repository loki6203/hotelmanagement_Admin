                        ...
                        <Dropdown.Menu className="dropdown-menu-sm" as={CustomDropdownMenu} align="end">
                            <div className="dropdown-content py-1">
                                <LinkList className="link-list-hover-bg-primary link-list-md">
                                    <LinkListItem to={`/user-manage/sales-add/${row._id}`}>
    ...
    return (
        <Layout title="Users List" content="container">
            <Block.Head>
                <Block.HeadBetween>
                    <Block.HeadContent>
                        <Block.Title tag="h2">Sales Representatives List</Block.Title>
                        <nav>
                    ...
                    <Block.HeadContent>
                        <ul className="d-flex">
                            <li>
                                <Button className="d-md-none" size="md" variant="primary" onClick={() => {navigate("/user-manage/sales-add")}}>
                                    <Icon name="plus" />
                                    <span>Add</span>
                                </Button>
                            </li>
                            <li>
                                <Button className="d-none d-md-inline-flex" variant="primary" onClick={() => {navigate("/user-manage/sales-add")}}>
                                    <Icon name="plus" />
            ...
            <Modal show={deleteModal} onHide={handleCloseModal}>
                <div className="modal-content">
                    <div className="modal-body p-5 text-center">
                        ...
                        <h3>Are You Sure ?</h3>
                        <p className="small">This sales representative will be removed permanently.</p>
