...
function EditProductPage() {
  ...
  return (
    <Layout title="Edit Hotel" content="container">
        <Block.Head>
            <Block.HeadBetween>
                <Block.HeadContent>
                    <Block.Title tag="h2">Edit Hotel</Block.Title>
                    <nav>
                        <ol className="breadcrumb breadcrumb-arrow mb-0">
                          <li className="breadcrumb-item"><Link to="/home">Home</Link></li>
                          <li className="breadcrumb-item"><Link to="/hotel-manage/hotels">Hotels</Link></li>
                          <li className="breadcrumb-item active" aria-current="page">Edit Hotel</li>
                        </ol>
                    </nav>
                </Block.HeadContent>
                <Block.HeadContent>
                    ...
                    <div className="gap gy-4">
                        ...
                        <div className="gap-col">
                            <ul className="d-flex align-items-center gap g-3">
                                ...
                                <li>
                                    <Link to="" className="btn border-0">Cancel</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
