...
function AddArea() {
    ...
    const onSubmit = async (formData) => {
        const { data, status } =  await axios.post(`Areas/create/`, formData);
        if (status == 200 || status == 201) {
    ...
    return (
        <Layout title="Add Area" content="container">
            <Block.Head>
                <Block.HeadBetween>
                    <Block.HeadContent>
                        <Block.Title tag="h2">Add Area</Block.Title>
                        <nav>
                            <ol className="breadcrumb breadcrumb-arrow mb-0">
                                <li className="breadcrumb-item"><Link to="/home">Home</Link></li>
                                <li className="breadcrumb-item"><Link to="/location/area/">Area</Link></li>
                            ...
                            <div className="gap gy-4">
                                            ...
                                            <Row className="g-gs">
                                                <Col lg="6">
                                                    <Form.Group className="form-group">
                                                        <Form.Label htmlFor="productname">Area</Form.Label>
                                                ...
                                                <Col md="6">
                                                    <Form.Group className="form-group">
                                                        <Form.Label htmlFor="productname">Location</Form.Label>
                                                        <div className="form-control-wrap">
                                                            <Select
                                                                name="colors"
                                                                options={cities}
                                ...
                                <div className="gap-col">
                                    <ul className="d-flex justify-content-end align-items-center gap g-3">
                                        <li>
                                            <Link to="/location/area/" className="btn border-0">Cancel</Link>
                                        </li>
                                        <li>
