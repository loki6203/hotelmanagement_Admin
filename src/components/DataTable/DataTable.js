...
function DataTableComponent({data, columns, className, expandableRows, actions, tableClassName,search, selectableRows, ...props}) {
    ...
    useEffect(() => {
        const filteredData = data.filter(
            item => (search ? item[`${search}`] : item?.title)?.toLowerCase().includes(searchText.toLowerCase())
        );
